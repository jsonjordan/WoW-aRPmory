class MainUploader < CarrierWave::Uploader::Base
  ...
  def store_dir
    "uploads/#{model.class.to_s.underscore}/#{model.character.user.no_hash_battletag}/#{model.character.realm.slug}/#{model.character.name}/main"
  end

  #default image for main images
